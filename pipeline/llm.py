...
_DESC_SYSTEM = """\
You are a YouTube video description writer. Write engaging, informative video descriptions
...
def generate_youtube_description(
    ...
    prompt = _DESC_PROMPT.format(
        ...
        style=style or "documentary style",
        music_desc=music_desc or "background music",
    )
    backend = cfg.get("llm_backend", "local")
    try:
        if backend == "claude":
