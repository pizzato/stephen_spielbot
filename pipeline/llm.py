...
def _json_script_generate(title: str, n_scenes: int, style_hint: str | None,
    ...
    *call_fn(system, user_msg, max_tokens, label, retries=...)* → str.
    ...
    dialogue_schema = (
        ...
        '"shot": <20-40 word STATIC close framing showing ONLY the speaker in this scene\'s setting — '
        'a single person, medium close-up or close-up, their face LARGE, centered and clearly '
        'visible, looking toward the camera; NO other characters in the frame; include setting '
        'details behind them>}. '
