...
class PublicConfigTests(unittest.TestCase):
    def test_secret_values_are_blanked_with_set_flags(self):
        ...
        self.assertEqual(pub["openai_api_key"], "")
...
class MergeConfigUpdateTests(unittest.TestCase):
    def test_blank_secret_keeps_stored_value(self):
        current = {"claude_api_key": "sk-ant-SECRET", "grok_api_key": "xai-SECRET",
                   "openai_api_key": "sk-OPENAI", "hf_token": "hf_SECRET"}
        update = {"claude_api_key": "", "grok_api_key": "", "openai_api_key": "", "hf_token": ""}
        ...
        self.assertEqual(merged["openai_api_key"], "sk-OPENAI")
