...
| MiniMax H3 Ref2VA Turbo LoRA (opt-in few-step distillation trained on Ref2VA; installed with its key names rewritten for the H3 turbo node) | `lightx2v/Minimax-h3-Turbo` (`minimax_h3_ref2v_turbo_4step_v0.1_comfyui_bf16`) | Apache-2.0 (the base H3 weights it patches keep the MiniMax H3 Community License) | ✅ LoRA itself yes; output remains bound by the H3 terms above |
