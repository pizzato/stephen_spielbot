...
3. **Video** — [LTX 2.3](https://huggingface.co/Lightricks/LTX-2.3) (or opt-in [LTX 2.5](https://huggingface.co/Lightricks/LTX-2.5)) animates each scene from its still via ComfyUI (local or distributed workers)
