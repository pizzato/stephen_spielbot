...
| Burned-in subtitles | Burn the script's captions into the picture itself (open captions) on every render and rebuild — narrated scenes only (see [Settings → Cover & first frame](manual/settings.md#cover-first-frame)) |
