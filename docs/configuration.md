...
| Image engine | Per-style generate and edit engines; default FLUX.2 Klein. Opt-in `qwen-image-2.1` generates stills only (research license, ComfyUI ≥ v0.37.0) — see [Models → Image engines](models.md#image-engines-per-style) |
