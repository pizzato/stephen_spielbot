...
| **H3 latent** | The [MiniMax H3 latent upscaler](https://huggingface.co/LBH-123-AI/Minimax_h3_latent_Upscaler) — resizes inside H3's own latent space, at any factor up to 4×. Suits films rendered on H3; needs the H3 video VAE on the worker |
