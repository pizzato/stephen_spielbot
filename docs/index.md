...
| 2 | **Images** | [FLUX.2 Klein](https://huggingface.co/Comfy-Org/vae-text-encorder-for-flux-klein-4b) paints each scene's first frame, with recurring [characters](characters.md) held consistent via reference images. [Qwen-Image 2.1](models.md#image-engines-per-style) is an opt-in alternative (research license) |
