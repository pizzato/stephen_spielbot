...
| `engines.py` | The engine registries — image (FLUX.2 Klein, FLUX.1 schnell, opt-in Qwen-Image 2.1), video (LTX 2.5, the MiniMax H3 family), and music (ACE-Step, MiniMax Music 3) |
