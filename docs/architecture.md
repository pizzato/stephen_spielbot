...
| `engines.py` | The engine registries — image (FLUX.2 Klein, FLUX.1 schnell), video (LTX 2.5, the MiniMax H3 family), and music (ACE-Step, MiniMax Music 3). YuE2 is a [planned extra](yue2_music.md), not a live music engine |
