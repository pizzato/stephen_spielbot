              ...
              {llmBackend === 'openai' && (
                <>
                  ...
                  <Field label="OpenAI model" hint="e.g. gpt-4o, gpt-4.1, gpt-4o-mini">
                    <input className="input" value={cfg.openai_model || 'gpt-5.6-luna'} onChange={(e) => set('openai_model', e.target.value)} />
                  </Field>
