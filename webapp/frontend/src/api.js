...
export const api = {
  ...
  // Catalogue character create (Create's music-video "create one"). Returns { config }.
  addCharacter: (body) => req('POST', '/characters', body),
  ...
  saveSong: (jobId, caption, lyrics, direction = null, vocalist = null, singer = null, noMainCharacter = null) =>
    req('PUT', `/jobs/${jobId}/song`, { caption, lyrics, direction, vocalist, singer, no_main_character: noMainCharacter }),
  // Re-write one half of the song — "lyrics" or "caption" (the Sound field);
  // the other half is sent as the editor has it and kept.
  regenSong: (jobId, field, caption, lyrics, instruction = '', direction = null, vocalist = null, singer = null, noMainCharacter = null) =>
    req('POST', `/jobs/${jobId}/song/regenerate`, { field, caption, lyrics, instruction, direction, vocalist, singer, no_main_character: noMainCharacter }),
